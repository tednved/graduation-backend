...
| API-01 | `docs/API-01-openapi-contract` | API 契约 Agent | IN_PROGRESS | 2026-09-10 | [#4](https://github.com/tednved/graduation-backend/pull/4)（Draft） | `docs/handoffs/API-01.md` | OpenAPI 3.1 MVP 契约（基线 DB-02 `bea0f7b8`） | 2026-09-10 |
