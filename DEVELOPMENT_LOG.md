...
| API-01 | `docs/API-01-openapi-contract` | API 契约 Agent / Codex | REVIEW | 2026-09-10 | [#4](https://github.com/tednved/graduation-backend/pull/4) | `docs/handoffs/API-01.md` | OpenAPI 3.1 / Flyway V6 `bea0f7b8` | 2026-09-11 |
