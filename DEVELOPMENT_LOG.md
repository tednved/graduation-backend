...
| BE-MVP-02 | `feat/BE-MVP-02-item-favorite` | Claude | IN_PROGRESS | 2026-09-12 | [#6](https://github.com/tednved/graduation-backend/pull/6) | `docs/handoffs/BE-MVP-02.md` | API-01 `e15baa77` + `PUT /items/{id}` 全量替换裁定（本分支改契约，见 `docs/api/contract-decisions.md` §3.1）/ Flyway V6 | 2026-09-12 |
