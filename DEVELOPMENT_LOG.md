...
| DOC-01 | `docs/DOC-01-delivery` | Claude | REVIEW | 2026-09-14 | 见 PR | 无（交付材料在根目录，不受 Git 管理） | 无契约与 Flyway 变化；README 重写为可复现启动说明并补演示数据准备命令与三个实测坑；OpenAPI 53 操作复验 PASS、健康检查 UP、多账号登录可用 | 2026-09-14 |
