...
| QA-01 | `fix/QA-01-final` | Claude / Codex | DONE | 2026-09-13 | [#8](https://github.com/tednved/graduation-backend/pull/8) | `docs/handoffs/QA-01.md` | 合并提交 `a2b6f48`；MySQL 63/63、HTTP 59/0/1、GUI 90/0/0、OpenAPI 53 操作 | 2026-09-14 |
| DOC-01 | `docs/DOC-01-delivery` | Claude | REVIEW | 2026-09-14 | [#9](https://github.com/tednved/graduation-backend/pull/9) | 无（交付材料在根目录，不受 Git 管理） | 无契约与 Flyway 变化；README 重写为可复现启动说明并补演示数据准备命令与三个实测坑；OpenAPI 53 操作复验 PASS、健康检查 UP、多账号登录可用 | 2026-09-14 |
| DOC-01 | `docs/DOC-01-delivery` | 待领取 | READY | 2026-09-14 | 待创建 | 待创建 | 基线 `a2b6f48`；仅启动/演示/验收文档，无业务代码改动 | 2026-09-14 |
